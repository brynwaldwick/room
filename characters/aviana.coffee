...
grammar = nalgene.parse '''
    ...
    %president
        ...
        I've been given the green light to always watch him.
        ...
        The most common string in the universe was his Tweet: "The brave step in when the fervor grows its tread."
