...
Story = {
    ...
    Hallway:
        inspect: 'It stretches away from you. There is a #door along the right side and a #door far ahead of you. There is a vague notion of #stairs going up and to the left. A #painting hangs on the wall opposite the #near_door. \n
            A #gargoyle sits on a pedestal. He chuckles  with a gravel pitch and clears his throat with anticipation. "The Butler did it, you know" he delivers in a jaunty grunt. "Not really mate, but I found myself unable to resist the irony."'
        Painting:
